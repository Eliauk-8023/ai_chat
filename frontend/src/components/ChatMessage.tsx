    ...
    <div className={`chat-message fade-in-up ${isUser ? 'user-message' : 'assistant-message'}`}>
      <div className="flex items-start space-x-3 sm:space-x-4">
        ...
        <div className={`flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center shadow-lg ${
          ...
          {isUser ? <User size={16} className="sm:w-[18px] sm:h-[18px]" /> : <Bot size={16} className="sm:w-[18px] sm:h-[18px]" />}
        </div>
          ...
          <div className="flex items-center justify-between mb-2 sm:mb-3">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <button
                ...
                className="p-1 sm:p-1.5 text-gray-400 hover:text-blue-600 transition-colors rounded-lg hover:bg-blue-50"
                title="复制"
              >
              ...
              {isUser && onResend && (
                <button
                  onClick={onResend}
                  className="p-1 sm:p-1.5 text-gray-400 hover:text-green-600 transition-colors rounded-lg hover:bg-green-50"
                  title="重新发送"
                >
