      ...
      <div className="max-w-4xl w-full text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          >
            ...
            <h3 className="font-semibold text-gray-900 mb-2 group-hover:text-blue-600">智能对话</h3>
          ...
          >
            ...
            <h3 className="font-semibold text-gray-900 mb-2 group-hover:text-green-600">网络搜索</h3>
            <p className="text-sm text-gray-600">实时获取最新信息</p>
          </button>
          ...
          >
            ...
            <h3 className="font-semibold text-gray-900 mb-2 group-hover:text-purple-600">代码助手</h3>
            <p className="text-sm text-gray-600">编程问题解答与代码生成</p>
          </button>
          ...
          >
            ...
            <h3 className="font-semibold text-gray-900 mb-2 group-hover:text-yellow-600">创意灵感</h3>
            <p className="text-sm text-gray-600">激发创意与想象力</p>
          </button>
        </div>
